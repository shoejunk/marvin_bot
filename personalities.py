...
BASE_INSTRUCTIONS = (
    ...
    "\n- {\"name\": \"set_thermostat\", \"parameters\": [\"entity_id\", \"temperature\", \"mode\"]} - Set thermostat temperature (mode is optional, defaults to 'heat')"
    "\n  * Example: When user asks to set the upper AC to 72 degrees, use {\"name\": \"set_thermostat\", \"parameters\": [\"climate.upper_thermostat_thermostat\", 72, \"cool\"]}"
    "\n- {\"name\": \"get_thermostat\", \"parameters\": [\"entity_id\"]} - Get current thermostat state"
    "\n  * Example: When user asks about the current temperature of the lower thermostat, use {\"name\": \"get_thermostat\", \"parameters\": [\"climate.lower_thermostat_thermostat\"]}"
    "\n- {\"name\": \"turn_off_thermostat\", \"parameters\": [\"entity_id\"]} - Turn off a thermostat"
    "\n  * Example: When user asks to turn off the upper AC, use {\"name\": \"turn_off_thermostat\", \"parameters\": [\"entity_id\"]}"
    "\n- {\"name\": \"set_hvac_mode\", \"parameters\": [\"entity_id\", \"mode\"]} - Set HVAC mode (cool, heat, off, etc.)"
